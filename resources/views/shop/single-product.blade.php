                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="shop/img/product-thumb-1.jpg" class="recent-thumb" alt="">
                            ...
                            <div class="col-sm-6">
                                <div class="product-images">
                                    ...
                                    <div class="product-gallery">
                                        <img src="shop/img/product-thumb-1.jpg" alt="">
                                        <img src="shop/img/product-thumb-2.jpg" alt="">
                                        <img src="shop/img/product-thumb-3.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="related-products-carousel">
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img src="shop/img/product-1.jpg" alt="">
                                ...
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img src="shop/img/product-3.jpg" alt="">
                                        <div class="product-hover">
                                            <a href="" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                            <a href="" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                        </div>
                                ...
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img src="shop/img/product-5.jpg" alt="">
                                        <div class="product-hover">
                                            <a href="" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                            <a href="" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                        </div>
                                ...
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img src="shop/img/product-6.jpg" alt="">
                                        <div class="product-hover">
                                            <a href="" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                            <a href="" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                        </div>
                    ...
                    <div class="product-content-right">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <img src="/{{$SanPham->DuongDanAnh}}" alt="abc">
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-price">
                                        <ins>{{$SanPham->GiaKhuyenMai}}VND</ins> <del>{{$SanPham->Gia}}VND</del>
                                    </div>    
                                    
                                    <form action="?page=order&add=" method="post" class="cart">
                                        <div class="quantity">
                                    ...
                                    <div class="product-inner-category">
                                        <p>Category: <a href="" style="pointer-events: none; cursor: default;"></p>
                                    </div> 
